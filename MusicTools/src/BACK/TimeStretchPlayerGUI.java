...
public class TimeStretchPlayerGUI extends JFrame 
  // JFrameを拡張する
  implements ActionListener, ChangeListener { 
     // ChangeListenerはスライダーを使うとき
  private int fontSize; 
      // private 基本的にクラスの中でだけ使える変数の定義
  private int gain;
     // 他のメソッドの境界を超えて他のメソッドでも同じ変数として使える
  ...
  TimeStretchPlayerGUI() throws Exception { 
   // throws Exception ここの中で例外処理はしないといういう意味 コンストラクタ
